    ...
    return (
        <section style={{ backgroundImage: `url(${bgImage})` }}
            ...
            <div className='bg-navy bg-opacity-70'>
                <div className='pt-64 pb-36 text-center max-w-3xl mx-auto'>
                    <h1 className='text-3xl md:text-5xl font-semibold text-white mb-8 leading-[90px]'>Campus Connect is A College Booking Platform</h1>
