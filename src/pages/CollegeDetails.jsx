    ...
    return (
        <section>
            ...
            <div className="container py-20">
                ...
                <div className="bg-white p-4 rounded-lg shadow-2xl hover:shadow-2xl duration-300 flex flex-col lg:flex-row gap-4">
                    <img src={collegesData.collegeImage} alt={collegesData.collegeName} className="full lg:w-[450px] rounded-lg object-cover" />

                    <div>
                        <div className='flex items-center gap-1 mt-1'>
                            <span className="text-sm">{collegesData.rating}</span>
                            <Rating className='max-w-[80px]' readOnly value={collegesData.rating} itemStyles={myStyles} />
                        </div>

                        <h2 className="text-red text-2xl font-semibold mb-2 mt-2 drop-shadow-lg line-clamp-1">{collegesData.collegeName}</h2>
                        ...
                        <p className="font-semibold mb-2 text-sm line-clamp-2 drop-shadow-lg"><span className="text-navy underline">Number of Research:</span> {collegesData.research}</p>

                        <p className="mb-2 text-sm line-clamp-2 drop-shadow-lg"><span className="font-semibold text-navy underline">Research History:</span> {collegesData.researchWorks}</p>

                        <Link to={`/admission_form/${collegesData._id}`} className="btn_primary w-full block text-center mt-4">Admission Now</Link>
                    </div>
                </div>
            </div>
        </section>
